...
@Deprecated
public class DEPRECATEDFrostShieldPower extends AstrayPower {
    public static final String ID = TAUtils.MakeID("FrostShieldPower");
    private final AbstractCard card;
    
    public DEPRECATEDFrostShieldPower(AbstractCreature owner, AbstractCard card, int amount) {
    ...
    public AbstractPower makeCopy() {
        return new DEPRECATEDFrostShieldPower(owner, card, amount);
    }
}
